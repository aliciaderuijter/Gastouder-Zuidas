<section class="section container-fluid entire-page position-relative" id="section2">
    <navbar active="overMij"></navbar>
    <div class="row pb-5 mb-5">
        <div class="col-12 col-lg-6 pl-lg-5 pt-5">


            <h1 class="font-cursive text-left">
                Beste Ouders,
            </h1>
            ...
            <p>
                ...
                met de kindjes. Daarnaast ga ik ook regelmatig
            ...
            <div class="col-12 col-lg-12 d-flex justify-content-end">
                <p class="font-cursive" style="font-size: 2em">
                    Saskia
                </p>
            </div>
